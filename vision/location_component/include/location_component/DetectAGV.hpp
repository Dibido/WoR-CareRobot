...
class DetectAGV
{
  ...
  /**
   * @brief The detectFrame function will analyse the frame end decide what the
   * current position is of the agv.
   *
  ...
  /**
   * @brief This function will create a correct perspective image. If the webcam is tilted it will correct the perspective.
   * 
   * @param frame - This matrix is the input image of the agv
   * @return boost::optional<DetectedAGV> -This param will only return of there is a AGV detected. There can only be made a perspective image of the is a AGV detected.
   */
  boost::optional<DetectedAGV> detect(const cv::Mat& frame);


  /**
   * @brief This function will transform the matrix with transformation information.
   * 
   * @param transmtx - This param will have the information how transform the matrix
  ...
  /**
   * @brief This function will return the midpoint of a contour aka a vector of opencv points.
   * 
