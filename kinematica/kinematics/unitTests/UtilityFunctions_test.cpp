...
namespace kinematics
{
  ...
  TEST(UtilityFunctions, MatrixCosineSim)
  {
    ...
    EXPECT_EQ(true, transformationMatrixCosineSim(lhs, rhs, 0.995, 0.001, 3));

    EXPECT_EQ(true, transformationMatrixCosineSim(lhs, rhs, 0.995, 0.001, 3));

    // EXPECT_EQ(true, transformationMatrixCosineSim(lhs, rhs, 0.99, 1, 3));

    EXPECT_EQ(false,
              transformationMatrixCosineSim(lhs, rhs, 0.995, 0.00001, 3));
  }
