...
/**
 * This class has been copied from the library libfranka.
 * Reason: This class was originally in examples_common.h and could not be
 * found.
 */
...
franka::JointPositions MotionGenerator::
    operator()(const franka::RobotState& robot_state, franka::Duration period)
{
  time_ += period.toSec();
